...
CREATE TABLE tipoactividad (idtipoactividad INT AUTO_INCREMENT, id_curso INT NOT NULL, valor_ponderacion BIGINT, nombre VARCHAR(45) NOT NULL, parcial BIGINT NOT NULL, factor_asist_1 INT DEFAULT '0' NOT NULL, factor_asist_2 INT DEFAULT '0' NOT NULL, INDEX id_curso_idx (id_curso), PRIMARY KEY(idtipoactividad)) ENGINE = INNODB;
