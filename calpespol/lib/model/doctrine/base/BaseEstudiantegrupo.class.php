 ...
 * 
 * @property integer $idestudiantegrupo
 * @property integer $idgrupo
 * @property integer $id_estudiante
 * @property Grupo $Grupo
 * @property UsuarioCurso $UsuarioCurso
 * 
 * @method integer         getIdestudiantegrupo() Returns the current record's "idestudiantegrupo" value
 ...
 * @method Estudiantegrupo setIdestudiantegrupo() Sets the current record's "idestudiantegrupo" value
...
abstract class BaseEstudiantegrupo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('idestudiantegrupo', 'integer', 4, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => true,
