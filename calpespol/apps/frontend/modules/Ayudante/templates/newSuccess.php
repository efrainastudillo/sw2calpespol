<?php slot('logo') ?>
    <?php echo image_tag('/images/estudiantes.png', array('alt_title'=>'Ayudantes','class'=>'hola')) ?>
<?php end_slot(); ?>
<?php slot('title') ?>
    <?php echo "Ayudantes" ?>
<?php end_slot(); ?>
    ...
    <div class="body_panel">
        ...
        <div class="titulo_body_panel">
            <div style="margin-right:200px;color: red;"  class="extra_head_panel">
               <?php if ($sf_user->hasFlash('nuevo_ayudante')): ?>
                  <div><?php echo $sf_user->getFlash('nuevo_ayudante') ?></div>
                <?php endif ?>
            </div>
        </div>
        
        <div id="regresar_lista" class="boton_new">
            <a href="<?php echo url_for("Ayudante/index")?>" class="button rounded black" >
                <img src="../images/new.png" width="15" height="15" /> Regresar a Lista de Ayudantes
            </a>
        </div>
        <div style="clear: both;visibility: hidden"></div>
        <div>
            <form id="form_edit_estudiante" action="<?php echo url_for('Ayudante/create') ?>" method="POST">
              <table>
        ...
        <div class="mensaje_ayuda"><p>Verifique que el Ayudante que quiere Ingresar al Sistema Corresponda al Paralelo y Materia Actual</p></div>
    </div> 
